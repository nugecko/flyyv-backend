...
def create_alert(payload: AlertCreate, x_user_id: str = Header(..., alias="X-User-Id")):
    ...
    try:
        ...
        return AlertOut(
            ...
            best_price=None,
            best_price_departure_date=None,
            best_price_booking_urls=None,
    ...
    try:
        ...
        for a in alerts:
            result.append(AlertOut(
                ...
                best_price_departure_date=getattr(a, "best_price_departure_date", None),
                best_price_booking_urls=getattr(a, "best_price_booking_urls", None),
